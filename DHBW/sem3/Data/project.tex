...
% Verkauft fehlt Zuordnung zu Filiale - done
...
Produkt: \{[\underline{ProduktID: integer}, Name: string, Preis: integer]\}

Verkauf: \{[\underline{VerkaufID: integer}, Datum: datetime, Gesamtbetrag: integer, FilialeID: integer]\}
...
Lagerbestand: \{[\underline{ProduktID: integer, FilialeID: integer}, Status: integer, Lagerbestand: integer]\}
