...
\begin{itemize}
    \item Mitarbeiter(MitarbeiterID, Gehalt, Adresse, Geburtsdatum, Nachname, Vorname)
    \item Produkt(ProduktID, Produktname, Preis, Status, Lagerbestand)
    \item Verkauf(VerkaufID, Datum, Gesamtbetrag)
    \item verkauft(ProduktID, VerkaufID, Menge, MitarbeiterID)
\end{itemize}
