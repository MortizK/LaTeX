...
Produkt: \{[\underline{ProduktID: integer}, Name: string, Preis: integer, Status: string, Lagerbestand: integer]\}

Verkauf: \{[\underline{VerkaufID: integer}, Datum: datetime, Gesamtbetrag: integer, FilialeID: integer, MitarbeiterID: integer]\}
...
verkauft: \{[\underline{ProduktID: integer, VerkaufID: integer}, Menge: integer]\}
