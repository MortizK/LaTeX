...
\begin{landscape}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=2\textwidth]{./fig/ERM_Überarbeitet.png}
        \caption{ERM von Niklas Reusch - Überarbeitet am 15.04.2026}
...
\subsection{Beispiel CREATE TABLE}
...
\subsection{Beispiel ALTER TABLE}
