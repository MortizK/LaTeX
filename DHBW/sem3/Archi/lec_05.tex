...
\know{Aufgabe}{Wie lange benötig die erste Addition von a, b nach p? Und die Folgenden? Slide S. 105: $t_p$ ist eine Schiebregister, was auch beschrieben werden kann.

erste Addition:
\begin{equation*}
    t = 1\tau + t_{CLA} + t_p = 1\tau + 6\tau + 5\tau = 12\tau
\end{equation*}

weitere Additionen:
\begin{equation*}
    t = t_{ALU} + 2 * t_p = 16\tau
\end{equation*}}

\begin{align*}
    t_{mux}&=2\tau\\
    t_{schiebe}&=3\tau\\
    t_{schiebe.schreiben}=t_{mux}+t_{schiebe}&=5\tau
\end{align*}

Das $t_{schiebe.schreiben}$ braucht jeweils für schreiben oder schieben $5\tau$.
