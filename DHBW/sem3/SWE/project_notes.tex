...
\marginpar{2026-03-18}

Wie sollen die Punkte verteilt werden für Probeklausuren und Klausuren?

Der Datensatz umfasst im Normalfall nur so viele Probeklausuraufgaben, für genau eine Klausur. Somit muss hier keine Random Probeklausur generiert werden. WICHTIG bleibt nur, das keine echten Aufgaben in der Probeklausur auftauchen.

Wenn wir noch Änderungen oder Ergänzungen an den Use-Cases machen, sollen wir das in den Anforderungen aktualisieren?

Alles muss noch aktualisiert werden, wenn wir Änderungen an den Anforderungen machen. Somit müssen für die Abgabe alle Dokumenten laufend aktualisiert werden.
