...
i) $\langle a \mid a \rangle\geq0, =0\iff a=0$ (definitheit)

ii) $\langle a \mid b \rangle = \langle b \mid a \rangle$ (Symmetrie)

iii) $\langle a \mid t*b+s*c \rangle=t\langle a \mid b \rangle+s*\langle a \mid c \rangle$ (Bilinearität)
...
ii) $a\times (b+c)=a\times b+a\times c$ und $a\times tb= t*a\times b$

iii) $a\times b \perp a \land a\times b \perp b$

iv) $\|a\times b\|=$ Fläche des Parallelogramms welches von a und b aufgespannt wird = $\|a\|* \|b\|*\sin(\alpha)$

v) $a, b, a\times b$: Rechte-Hand-Regel
