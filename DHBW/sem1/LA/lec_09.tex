...
\begin{enumerate}
    \item[i)] $\|x\|\geq 0$, $=0\iff x=0$ Nur Null, wenn es der Nullvektor ist (Definitheit)
    \item[ii)] $\|tx\|=|t|*\|x\|$ (Homogenität)
    \item[iii)] $\|x+y\|\leq \|x\|+\|y\|$ (Dreiecks-Ungleichung)
\end{enumerate}
...
\begin{enumerate}
    \item[i)] $d(x,y)\geq 0$, wenn $=0\iff x=y$
    \item[ii)] $d(x, y)= d(y, x)$
    \item[iii)] $d(x, y)\leq d(x, z) + d(z, y)$ (Dreiecks-Ungleichung)
\end{enumerate}
