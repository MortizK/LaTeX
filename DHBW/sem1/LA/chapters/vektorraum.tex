...
\begin{enumerate}
    ...
    \item Die Diskriminante bestimmen: $\Delta=(\frac{p}{3})^3+(\frac{q}{2})^2$
    ...
    \item Bei $\Delta=0$ mindestens eine mehrfache Nullstelle
    \item Bei $\Delta<0$ Drei Reelle Lösungen
\end{enumerate}
