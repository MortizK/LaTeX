...
\begin{enumerate}
    \item[i)] $p|a*b\land ggT(a,p)=1\implies p|b$
    \item[ii)] $p|ab\land p\in \mathbb{P}\implies p|a \lor p|b$
\end{enumerate}
...
\begin{enumerate}
    \item[i)] $ggT(p,a)=1\implies 1=ta+sp\mid *b\implies b=t*ab+sb*ptkp+sbp=(tk+sb)*p\implies p|b$
    \item[ii)] $p|ab\land p\in \mathbb{P}$: Zwei Fälle $\substack{ggT(a,p)=p\implies p|a\\ggT(a,p)=1\substack{\text{i)}\\ \implies}p|b}$
\end{enumerate}
