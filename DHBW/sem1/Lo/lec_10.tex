...
map kann auch mehrere Parameter haben, aber nur dann, wenn die Funktion in map mehrere Parameter braucht. Aso z.B.: (map (lambda (x y) (if (> x y) x y)) '(2 5) '(3 4)) => '(3 5)
